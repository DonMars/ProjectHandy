...
namespace VrGamesDev
{
	...
	public class VRG_SkinPool : VRG_Base
	{
		...
		public static IEnumerator IsValid(bool valueLocal)
		{
			...
			{
				if (GameObject.FindAnyObjectByType<VRG_SkinPool>() == null)
				{
					bContinue = false;
				}
			}
		...
		public static void Set(VRG_Skin valueLocal)
		{
			if (valueLocal != null)
			{
				...
				// get all the VRG_UI
				VRG_UI[] vrg_UI = Object.FindObjectsByType<VRG_UI>(FindObjectsSortMode.None);
				...
				else
				{
					...
					{
						VRG_CameraBackground vrg_CameraBackground = Object.FindAnyObjectByType<VRG_CameraBackground>();
